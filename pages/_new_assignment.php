...
<div class="container-form">
    ...
    <form method="POST" action="<?= BASEURL; ?>/save-assignment/<?= $dataUser['_id_pekerja']; ?>" class="form-input">
        ...
        <input type="date" name="date" value="<?= date('Y-m-d'); ?>" class="date" required><br>
