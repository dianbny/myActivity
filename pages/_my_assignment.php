...
<label class="labelTitle"><i class="fa fa-angle-double-right" aria-hidden="true"></i>&nbsp;My Assigment</label>
    ...
    <form method="POST" action="my-assignment" class="form-table">
        ...
        ?>
        <span style="font-size:12px;">My Assigment : <?= $bulan."/".$tahun; ?> | Ket :&nbsp; <i class="fa fa-circle" aria-hidden="true" style="color:dodgerblue"></i>&nbsp; Request, <i class="fa fa-circle" aria-hidden="true" style="color:green"></i>&nbsp; Done, <i class="fa fa-circle" aria-hidden="true" style="color:darkorange"></i>&nbsp; Pending </span>
