...
<div class="container-form">
    ...
    <form method="POST" action="<?= BASEURL; ?>/update-my-assignment/<?= $id; ?>" class="form-input">
        ...
        <input type="date" value="<?= $dataAssignment['_tanggal_tugas']; ?>" class="date" required readonly><br>
        ...
        <button type="button" class="btnForm" onclick="window.location.href = '<?= BASEURL; ?>/my-assignment'">Back</button>
